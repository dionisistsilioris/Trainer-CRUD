<%-- 
    Document   : updateform
    Created on : Jun 27, 2020, 10:59:02 PM
    Author     : Dionisis
--%>
...
<html>
    ...
    <body>
        <nav class="navbar">
            <a class="navbar-brand" href="/showtrainers">Return to table</a>
        </nav>
        ...
        <div id="teacher">
           ...
           <div id="form" action="updatetrainer" method="post" modelAttribute="updatetrainer"> 
        <h1>Update Trainer </h1>
       <springform:form action="updatetrainer" method="post" modelAttribute="updatetrainer" cssClass="main-form needs-validation" novalidate="novalidate">
